	...
	!(function (e, n, t) {
		...
		function i(e) {
			...
			Modernizr._config.enableClasses &&
				((n += ' ' + t + e.join(' ' + t)), P ? (_.className.baseVal = n) : (_.className = n));
		}
		function a() {
		...
		function u(e, n, t) {
			...
			for (var i in e)
				if (e[i] in n)
					return t === !1 ? e[i] : ((o = n[e[i]]), r(o, 'function') ? f(o, t || n) : o);
			return !1;
		}
		function c(e) {
			return e
		...
		function g(e, n, o, i) {
			...
			for (var c, d, p, m, g, y = ['modernizr', 'tspan', 'samp']; !N.style && y.length; )
				(c = !0), (N.modElem = a(y.shift())), (N.style = N.modElem.style);
			for (p = e.length, d = 0; p > d; d++)
				if (((m = e[d]), (g = N.style[m]), l(m, '-') && (m = s(m)), N.style[m] !== t)) {
...
function aa(a) {
	...
	f('input');
	g(t[aa.$l]);
	e('tsound-main', n.A.pm, function (a, canvasOff = true) {
		if (!canvasOff) n.Na.im(a ? 1 : 0);
	});
...
export function handleFile(e) {
	...
	if (!(1 > a.length)) {
		...
		b.onload = async function () {
			if (b.result == null || typeof b.result == 'string') {
...
function Nb(a) {
	...
	var c = null,
		c = function () {
			...
			0 >= a
				? b.ia()
				: (window.clearTimeout(b.Am), (a = window.setTimeout(c, a + 1000)), (b.Am = a));
		};
	c();
...
function Va(a, b, c) {
	...
	this.Ra.onicecandidate = function (a) {
		null == a.candidate
			? d.Vo(d.Uf)
			: ((a = a.candidate),
			  null != a.candidate && '' != a.candidate && (null != d.jg && d.jg(a), d.Uf.push(a)));
	};
...
F.prototype = {
	...
	ie: function (a) {
		var b = this.a,
			...
			d = '';
		for (a = b + a; b < a; )
			(c = F.jo(this.o, b)), (b += c.length), (d += String.fromCodePoint(c['char']));
		if (b != a)
					  ...
					  2097152 <= a
							? (this.o.setUint8(b + 3, (a >> 21) | 128),
							  268435456 <= a
									...
									: (this.o.setUint8(b + 3, this.o.getUint8(b + 3) & 127), (a = 4)))
							: (this.o.setUint8(b + 2, this.o.getUint8(b + 2) & 127), (a = 3)))
...
mc.ts = function () {
	...
	a.RTCSessionDescription =
		a.webkitRTCSessionDescription || a.mozRTCSessionDescription || a.RTCSessionDescription;
...
xa.prototype = C(V.prototype, {
	...
	Sf: function () {
		return this.wd()
			? (0 > this.bc && (this.bc = 0),
			  this.wk(
					window.performance.now() * this.Ac + this.Qi.$g(0.5) - this.Y + this.bc + this.rd,
					this.ug
			  ))
			: this.T;
	},
	...
	Bl: function () {
		if (3 == this.pd) {
			for (var a = 0, b = this.pi; a < b.length; ) {
				...
				++a;
				c.frame <= this.Y ||
					(c.yf == this.te + this.cc + this.le.bs(c.frame) && this.vn(c.frame - this.Y));
			}
...
Lb.prototype = C(V.prototype, {
	...
	Sf: function () {
		0 > this.bc && (this.bc = 0);
		return this.wk(
			(window.performance.now() - this.Li) * this.Ac - this.Y + this.wi + this.bc + this.rd
		);
	},
	Oo: function (a, b) {
...
Jb.prototype = C(V.prototype, {
	...
	C: function () {
		...
		this.Wh = a;
		0 < this.Fd
			? ((this.Qb += 10000), this.Qb > this.Fd && ((this.Qb = this.Fd), (this.Fd = -1)))
			: (this.Qb += b * this.pl);
		a = this.mf * this.mh;
		this.Qb > a && (this.Qb = a);
		b = this.Qb * this.Ac;
		...
		switch (c) {
			...
			case 'checksum':
				...
				d.Pe()
					...
					: ((d = J.Vg(d.Sj(), 8)), this.ba('Stadium: "' + a + '" (checksum: ' + d + ')'));
				break;
			case 'clear_avatar':
				this.fm(null);
			...
			case 'extrapolation':
				2 == a.length
					? ((a = K.parseInt(a[1])),
					  null != a && -200 <= a && 200 >= a
							? (n.A.rd.Xa(a), this.ya.gm(a), this.ba('Extrapolation set to ' + a + ' msec'))
			...
			case 'handicap':
				2 == a.length
					? ((a = K.parseInt(a[1])),
					  null != a && 0 <= a && 300 >= a
							? (this.ya.kr(a), this.ba('Ping handicap set to ' + a + ' msec'))
...
ba.prototype = {
	...
	uf: function () {
		...
		0 == a
			...
			: (b.Gg(!1), (c.xf = 35), -1 == a ? (c.jf = 450) : ((c.jf = 0), (c.kf = 1 + 0.25 * (a - 1))));
	},
	Cd: function (a) {
		this.ob.Cd(a.code);
	},
...
Gb.prototype = {
	...
	ri: function (a) {
		...
		var c = this;
		this.Ti(a);
		a.tl = function (b, canvasOff = true) {
		...
		a.ul = function (d, e, f, g, canvasOff = true) {
			y.i(c.Op, d.V);
			null == e
				? (d = '' + d.w + ' has left')
		...
		a.ji = function (canvasOff = true) {
			if (!canvasOff) {
				n.Na.cd(n.Na.bp);
			}
			//console.log("kick",n);
		};
		a.Ni = function (a, canvasOff = true) {
			if (!canvasOff) {
				n.Na.cd(n.Na.Io);
			}
			var b = c.j.Fb.Eb.td;
			...
			if (keepUpdating) {
				...
				if (match[match.length - 1].spaceMode) {
					if (a.w == toucher.team) {
						...
						if (lastToucher.name != undefined && a.w == lastToucher.team) {
							...
							match[match.length - 1].goals[
								match[match.length - 1].goals.length - 1
							].assist = false;
						}
					} else {
						match[match.length - 1].goals.push({
							scorer: toucher.name + ' (own goal)',
							assist: false,
							currentScore: [match[match.length - 1].scoreRed, match[match.length - 1].scoreBlue]
						});
					}
				...
				match[match.length - 1].goals[match[match.length - 1].goals.length - 1].goalIndex =
					goalParsed;
				goalParsed++;
			}
		};
		...
		a.Ki = function (a) {
			...
			if (match[match.length - 1].stopped && keepUpdating) {
				match.push({
					...
					scoreBlue: 0,
					goals: [],
					player: match[match.length - 1].player,
					playerActions: []
				});
				playerPos.push([]);
		...
		a.vf = function (a) {
			...
			if (keepUpdating) {
				...
				if (match.length > 1 && match[match.length - 1].gameTicks == -1)
		...
		a.xl = function (d, e, f) {
			...
			if (
				keepUpdating &&
				match[match.length - 1].started &&
				!match[match.length - 1].stopped &&
				match[match.length - 1].gameTicks > 0
			) {
				match[match.length - 1].changes.push([
					e.w,
					f.w,
					parseTime(match[match.length - 1].gameTicks)
				]);
			}
		...
		a.ii = function (a, e) {
			var d = e.w;
			c.j.Qa.Gb(
				(e.cb ? '' + d + ' was given admin rights' : '' + d + "'s admin rights were taken away") +
					b(a)
			);
		};
		a.wl = function (a, b) {
		...
		a.Hk = function (a, e, f, g) {
			c.j.Qa.Gb(
				'Kick Rate Limit set to (min: ' + e + ', rate: ' + f + ', burst: ' + g + ')' + b(a)
			);
		};
	},
	Lr: function (a) {
...
T.Fo = function () {
	return M.tk(
		/*n.Ee + 'api/geo'*/ 'https://kpias760.github.io/haxball-replay-analyzer.github.io/pliki/geo.json'
	).then(function (a) {
		return T.Rf(a);
	});
	//return false;
...
u.jk = function (a) {
	...
	b.cl = function (b, canvasOff = true) {
		n.A.fe.Xa(b);
		if (!canvasOff) {
			n.Na.Tl();
		}
...
u.oo = function () {
	...
	b.Jp = function (b) {
		...
		x.La(new P('Tworzenie ruma', 'Connecting...', []).g);
		var e = null,
			f = n.A.Lh(),
			g = new fa();
		g.jc = b.name;
	...
	try {
		...
		if (c instanceof Kb)
			(a = new P(
				...
				'The replay file is of a different version. You can open simple player, without stats',
				['Open player', 'Cancel']
			)),
				x.La(a.g),
				(a.Va = function (a) {
...
x.es = function (a) {
	for (
		var b = Modernizr,
			c = 'canvas dataview es6collections peerconnection promises websockets'.split(' '),
			d = [],
			e = 0;
		e < c.length;
...
va.get = function () {
	return M.L(
		/*n.Ee + */ 'https://kpias760.github.io/haxball-replay-analyzer.github.io/pliki/geo.json',
		'arraybuffer'
	).then(function (a) {
		...
		if (0 < this.Oa) 120 > this.Oa && this.Oa--;
								...
								if (4 > h - l.Z - d.H.Z) {
									...
									if (keepUpdating) {
										if (
											d.ea.w == 'Red' &&
											ball.vx > 0 &&
											99.762 * ball.vx + ball.x > blueGoalCord[0] &&
											ball.x < blueGoalCord[0]
										) {
											...
											d.ea.w == 'Blue' &&
											ball.vx < 0 &&
											99.762 * ball.vx + ball.x < redGoalCord[0] &&
											ball.x > redGoalCord[0]
										) {
											...
											if (kicker != undefined && d.w != kicker.name) {
												...
												if (lastKicker.team == d.ea.w) {
													...
													match[match.length - 1].passes.push({
														...
														shot: ball,
														lastShot:
															match[match.length - 1].kicks[
																match[match.length - 1].kicks.length - 2
															]
													});
			...
			for (g = d.length; e < g; )
				(f = e++),
					(k = d[f]),
					0 != (k.v & 128) &&
						((O.dk[c] = f), (f = O.Yk[c]), (k = k.a), (f.x = k.x), (f.y = k.y), ++c);
			this.ta.C(a);
			if (0 == this.Bb) {
				...
				if (!match[match.length - 1].stadium) {
					...
					function getColor(x) {
						if (x < 0) return 'transparent';
							...
							for (var c = ''; (c = '0123456789ABCDEF'.charAt(x & 15) + c), (x >>>= 4), 0 < x; );
							// if (null != b) for (; c.length < b; ) c = "0" + c;
							return c;
						}
					}
					...
					match[match.length - 1].stadium.ballPhysics = match[
						match.length - 1
					].stadium.discs.splice(0, 1)[0];
					delete match[match.length - 1].stadium.ballPhysics.pos;
					if (
						match[match.length - 1].stadium.bg.type != 'grass' &&
						match[match.length - 1].stadium.bg.color == '718C5A'
					) {
					...
					for (var i = 0; i < segments.length; i++) {
						...
						if (segments[i].v0 == 0 && segments[i].v1 == 0) {
							for (var j = 0; j < vertexes.length; j++) {
								if (
									vertexes[j].x == trueSegments[i].W.a.x &&
									vertexes[j].y == trueSegments[i].W.a.y
								)
									segments[i].v0 = j;
								else if (
									vertexes[j].x == trueSegments[i].ca.a.x &&
									vertexes[j].y == trueSegments[i].ca.a.y
								)
									segments[i].v1 = j;
					...
					if (
						st.w.toLowerCase().includes('real soccer') | st.w.toLowerCase().includes('realsoccer')
					)
						match[match.length - 1].realSoccerMode = true;
					if (
						(st.ld === 1) &
						(st.Td > 700) &
						(st.Sd > 400) &
						(st.w.includes('RS') | st.w.toLowerCase().includes('soccer'))
					)
						match[match.length - 1].realSoccerMode = true;
				...
				if (keepUpdating) {
					...
					match[match.length - 1].playerActions.push(frameArr);
					...
					for (var i = 0; i < b.length; i++) {
						if (playerPos[match.length - 1][playerList.indexOf(b[i].w)] == undefined)
							playerPos[match.length - 1][playerList.indexOf(b[i].w)] = [];
						if (b[i].H != null)
							playerPos[match.length - 1][playerList.indexOf(b[i].w)].push({
								x: b[i].H.a.x,
								y: b[i].H.a.y
							});
					}
					if (match[match.length - 1].spaceMode) {
						for (var i = 0; i < b.length; i++) {
							...
							for (var j = i + 1; j < b.length; j++) {
								...
								if (distanceBetween(b[i].H.a, b[j].H.a) < 30.0001)
									match[match.length - 1].bumps.push(b[i].w, b[j].w);
				...
				if (checkTeams && keepUpdating) {
					for (var i = 0; i < b.length; i++) {
						if (b[i].ea.w == 'Red' && !match[match.length - 1].redTeam.includes(b[i].w))
							match[match.length - 1].redTeam.push(b[i].w);
						else if (b[i].ea.w == 'Blue' && !match[match.length - 1].blueTeam.includes(b[i].w))
							match[match.length - 1].blueTeam.push(b[i].w);
					}
					checkTeams = false;
				}
		...
		for (c = 0; c < a.length; )
			if (((d = a[c]), ++c, this.Ck(d), (e = d.ea), e != p.Ia)) {
				var f = d.H.a,
					...
					l = e == p.fa ? g.Dd : g.md;
				0 == l.length
					? ((l = (k + 1) >> 1), 0 == (k & 1) && (l = -l), (g = g.kc * e.Ch), (k = 55 * l))
					: (k >= l.length && (k = l.length - 1), (k = l[k]), (g = k.x), (k = k.y));
				f.x = g;
				f.y = k;
				b[e.$]++;
				d.Jb = b[e.$];
	...
	Kn: function (a, b) {
		for (var c = 0, d = this.tc; c < d.length; ) {
			...
			var f = e.W,
				...
				k = b.x - a.x,
				l = b.y - a.y;
			0 < -(f.y - a.y) * k + (f.x - a.x) * l == 0 < -(g.y - a.y) * k + (g.x - a.x) * l
				? (f = !1)
				: ((k = g.x - f.x),
				  (g = g.y - f.y),
				  (f =
						0 < -(a.y - f.y) * k + (a.x - f.x) * g == 0 < -(b.y - f.y) * k + (b.x - f.x) * g
							? !1
							: !0));
			if (f) return e.qe;
		}
...
ob.prototype = C(m.prototype, {
	...
	va: function (a) {
		...
		this.Rc = [];
		for (c = 0; 3 > c; )
			(d = c++), (this.Rc[d] = null), 0 != (b & 1) && (this.Rc[d] = a.M()), (b >>>= 1);
	},
	f: ob
});
ma.b = !0;
...
ca.prototype = {
	...
	Qn: function (a) {
		...
		d >= this.Z ||
			...
			(d = b * d.x + c * d.y),
			0 > d &&
				((d *= this.m * a.m + 1), (e = a = this.D), (a.x = e.x - b * d), (a.y = e.y - c * d)));
	},
	sc: function () {
		var a = ya.zc,
			b = this.gc;
			...
			if (0 != c.aa) {
				...
				for (e = this.J; d < e.length; )
					if (
						...
						l = g * l.x + k * l.y;
						0 > l &&
							((l *= c.m * f.m + 1), (h = f = c.D), (f.x = h.x - g * l), (f.y = h.y - k * l));
					}
			}
		}
...
N.prototype = {
	...
	Kc: function (a, b) {
		...
		if (null != a.K) {
			...
			if (k == 1.5625) {
				...
				mouseTranslated.y =
					(mousepos.clientY + translatetoDisc.y - (this.sa.height + h) / 2 / k) / 1.25;
			} else if (k == 1.875) {
	...
	Mq: function (a, b) {
		if (!(0 > a.R)) {
			...
			null != c &&
				null != d &&
				((c = c.a), (d = d.a), this.c.moveTo(c.x, c.y), this.c.lineTo(d.x, d.y), this.c.stroke());
		}
	},
	Qq: function (a) {
		if (a.Za) {
...
Sb.prototype = {
	...
	C: function (a) {
		0 < this.ab.length &&
			((this.xc += a), this.xc > this.ab[0].zo() && ((this.xc = 0), this.ab.shift()));
	},
	Kc: function (a) {
	...
	Hq: function (a) {
		...
		if (!(1 > b.length)) {
			...
			for (var c = -32, d = 64 / b.length, e = 0; e < b.length; )
				(this.rb.fillStyle = N.lc(b[e++])), this.rb.fillRect(c, -32, d + 4, 64), (c += d);
			this.rb.restore();
...
lb.prototype = {
	...
	lk: function (a) {
		...
		this.Rp(
			D.substr(this.Ml, 0, this.si) + a + ' ' + D.substr(this.Ml, this.si + this.Vq, null),
			this.si + a.length + 1
		);
	},
	Ui: function (a) {
	...
	Qj: function (a) {
		if (null != this.Wc) {
			...
			a = this.Wc[this.wc];
			b != this.wc &&
				(a.Ja.classList.toggle('selected', !0), this.Wc[b].Ja.classList.toggle('selected', !1));
			a = a.Ja;
			b = a.offsetTop;
			a = b + a.offsetHeight;
...
Rb.prototype = {
	...
	ur: function (a) {
		a != this.ik &&
			((this.g.className = a ? 'game-timer-view time-warn' : 'game-timer-view'), (this.ik = a));
	},
	f: Rb
};
ja.b = !0;
ja.prototype = {
	C: function (a, canvasOff = true) {
		if (canvasOff) return;
	...
	bb: function (a, b) {
		...
		ja.kq = a;
		null != a
			? ((this.hf.style.display = 'flex'), this.hf.appendChild(a), (this.yl = b))
...
$a.prototype = {
	Il: function () {
		var a = this;
		M.tk(
			/*n.Ee + 'api/notice'*/ 'https://kpias760.github.io/haxball-replay-analyzer.github.io/pliki/notice.json'
		).then(function (b) {
			var c = b.content;
			null != c &&
				'' != c &&
...
kb.N =
	"<div class='choose-nickname-view'><img src=\"https://kpias760.github.io/haxball-replay-analyzer.github.io/images/falafcio.png\" /><div class='dialog'><h1>Haxball Replay Analyzer</h1><div style='display: none' class='label-input'><label>Nick:</label><input data-hook='input' type='text' /></div><button id='button_ok' data-hook='ok'>Start</button></div></div>";
jb.N =
...
hb.N =
	"<div id='game-state-view' class='game-state-view'><div class='bar-container'><div class='bar'><div class='scoreboard'><div class='teamicon red'></div><div class='score' data-hook='red-score'>0</div><div>-</div><div class='score' data-hook='blue-score'>0</div><div class='teamicon blue'></div></div><div data-hook='timer'></div></div></div><div class='canvas' data-hook='canvas'></div></div>";
ja.N =
